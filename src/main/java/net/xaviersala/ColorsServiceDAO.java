...
public class ColorsServiceDAO implements ColorsService {
   ...
   */
  @Override
  public Color getColor(String nom) throws IllegalArgumentException {
    simulateSlowService();
    Color c = repositori.findByNomIgnoreCase(nom);
    if (c == null) {
      throw new IllegalArgumentException("color no trobat");
    }
